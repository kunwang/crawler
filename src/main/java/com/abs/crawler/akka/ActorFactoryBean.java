...
public class ActorFactoryBean implements FactoryBean<ActorRef>, ApplicationContextAware {
	...
	private static class SpringCreator implements Creator<akka.actor.Actor> {
		...
		public akka.actor.Actor create() throws Exception {
			akka.actor.Actor actor = (akka.actor.Actor) ConstructorUtils.invokeConstructor(clazz, args);
			if(actor != null) {
